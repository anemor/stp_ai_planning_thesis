...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; start with domain and problem from scenario 1
; drone at a1 searching, get notification of low battery 
;   -> replan to get back to charge. 
;   When done charging -> replan to finish search

; set predicate (searched a5)
; set predicate (searched a6)
; set predicate (searched a7)
; set predicate (searched a0)
; set predicate (searched h0)

; remove predicate (drone_at d0 h0) 
; remove predicate (landed d0)
; set predicate (drone_at d0 a1)

; remove goal
; set goal (and (battery_charged d0))

; remove goal
; set goal (and (searched a1)(searched a2)(searched a3)(searched a4)(landed d0))